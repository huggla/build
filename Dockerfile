...
ONBUILD ARG INITCOPYSOURCE1
ONBUILD ARG INITCOPYDESTINATION1
ONBUILD ARG INITCOPYSOURCE2
ONBUILD ARG INITCOPYDESTINATION2
...
ONBUILD COPY --from=init1 ${INITCOPYSOURCE1:-/} ${INITCOPYDESTINATION1:-/imagefs}
ONBUILD COPY --from=init2 ${INITCOPYSOURCE2:-/} ${INITCOPYDESTINATION2:-/imagefs}
